classdef IVFSPEA2_V3_ETA10 < ALGORITHM
    % <2024> <multi> <real/integer/label/binary/permutation>
    % IVFSPEA2 V2-Ablation: SBX distribution index eta_c = 10 (H3)
    %
    ...
    %------------------------------- Reference --------------------------------
    % Ablation variant: SBX distribution index reduced from 20 to 10 to
    % increase offspring spread and exploration capability.
    %--------------------------------------------------------------------------
        ...
        function main(Algorithm, Problem)
            ...
            while Algorithm.NotTerminated(Population)
                [Population, ~, IVF_Gen_FE, IVF_Total_FE, Mating_N] = ...
                    IVF_V3_ETA10(Problem, Population, Fitness, Forca, Distancia, ...
