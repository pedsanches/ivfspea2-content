classdef IVFSPEA2ABL4C < ALGORITHM
    % <2024> <multi> <real/integer/label/binary/permutation>
    % IVFSPEA2 Ablation: top-4c father selection (broader pool)
    %
    ...
    %------------------------------- Reference --------------------------------
    % Ablation variant of IVF/SPEA2: father selected from top-4c instead of
    ...
    methods
        function main(Algorithm, Problem)
            ...
            while Algorithm.NotTerminated(Population)
                % IVF phase (ablation: top-4c)
                [Population, ~, IVF_Gen_FE, IVF_Total_FE, Mating_N] = ...
                    IVF_ABL_4C(Problem, Population, Fitness, Forca, Distancia, ...
