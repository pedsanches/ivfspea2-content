classdef IVFSPEA2_V5_MUTATION < ALGORITHM
    % <2024> <multi> <real/integer/label/binary/permutation>
    % IVFSPEA2 V2-Ablation: Post-SBX polynomial mutation on offspring (H5)
    %
    ...
    %------------------------------- Reference --------------------------------
    % Ablation variant: applies standard polynomial mutation (p_m = 1/D,
    % eta_m = 20) to IVF offspring AFTER SBX crossover. This matches the
    % standard practice in NSGA-II/SPEA2 GA operators.
    %--------------------------------------------------------------------------
        ...
        function main(Algorithm, Problem)
            ...
            while Algorithm.NotTerminated(Population)
                [Population, ~, IVF_Gen_FE, IVF_Total_FE, Mating_N] = ...
                    IVF_V5_MUTATION(Problem, Population, Fitness, Forca, Distancia, ...
