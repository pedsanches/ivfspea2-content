...
function local_execute_trace_run(row, problem_handle, case_row, case_id, display_label, role, ...
    ...
    try
        ...
        trace_run = struct( ...
            ...
            'cycles', {Algorithm.TraceCycles}, ...
            'n_generations', numel(Algorithm.TraceGenerations), ...
            'generations', {Algorithm.TraceGenerations}); %#ok<NASGU>
