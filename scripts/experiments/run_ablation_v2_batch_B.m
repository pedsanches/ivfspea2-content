% run_ablation_v2_batch_B.m
% =========================================================================
% ABLATION V2 - BATCH B: V2 (Collective Criterion) + V3 (eta_c = 10)
% =========================================================================
%
% This batch runs on Process 2 with 6 parpool workers.
% Configs: V2 (collective continuation criterion) and V3 (SBX eta_c = 10)
% Instances: 12 representative problems (M=2 and M=3)
% Runs: 30 per config-instance pair
%
% Usage:
%   matlab -nodisplay -r "run('/home/pedro/desenvolvimento/ivfspea2/scripts/experiments/run_ablation_v2_batch_B.m')"
%
% =========================================================================
...
log_file = fullfile(log_dir, sprintf('ablation_v2_batchB_%s.log', datestr(now, 'yyyymmdd_HHMMSS')));
diary(log_file);
fprintf('=== ABLATION V2 BATCH B - Log started: %s ===\n', datestr(now));
fprintf('MATLAB: %s\n', version);
fprintf('Log file: %s\n\n', log_file);
...
% Algorithms for this batch: V2 + V3
algorithms = {
    'IVFSPEA2_V2_COLLECTIVE', @IVFSPEA2_V2_COLLECTIVE; % V2: collective criterion
    'IVFSPEA2_V3_ETA10',      @IVFSPEA2_V3_ETA10;      % V3: eta_c = 10
};
